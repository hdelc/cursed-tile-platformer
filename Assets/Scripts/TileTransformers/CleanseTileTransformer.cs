...
class CleanseTileTransformer : TileTransformer
{
  public override Sprite Sprite { get => sprite; }
  private readonly Sprite sprite = Resources.Load<Sprite>(@"Sprites\green tile");
  ...
  {
    args.player.GetComponent<PlayerManager>()?.RequestEffect(PlayerEffect.CLEANSE);
  }
}
